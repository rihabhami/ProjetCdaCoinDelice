...
import fr.eql.ai111.projet3.coindelice.library.model.Product;
...
import fr.eql.ai111.projet3.coindelice.library.service.ShoppingCartService;
...
public class CartController {
    ...
    public String cart(Model model, Principal principal, HttpSession session){
        ...
        if(shoppingCart == null){
            model.addAttribute("check", "Aucun produit dans le panier");
        }
